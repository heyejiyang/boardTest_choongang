...
public class QFileInfo extends EntityPathBase<FileInfo> {
    ...
    private static final long serialVersionUID = 628675013L;

    public static final QFileInfo fileInfo = new QFileInfo("fileInfo");

    public final com.bbYang.global.entities.QBaseMemberEntity _super = new com.bbYang.global.entities.QBaseMemberEntity(this);
