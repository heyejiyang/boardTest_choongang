...
public class QAuthorities extends EntityPathBase<Authorities> {
    ...
    private static final long serialVersionUID = -1444407960L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QAuthorities authorities = new QAuthorities("authorities");

    public final EnumPath<com.bbYang.member.constants.Authority> authority = createEnum("authority", com.bbYang.member.constants.Authority.class);
